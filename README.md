...
A patched version of Facebook for iOS with SSL/TLS certificate pinning disabled, allowing HTTPS traffic inspection for security research, reverse engineering, and mobile application analysis.

This repository is maintained and updated regularly with support for newer Facebook releases.
...
| --------- | ------------------- | ------- | --------- | ------------------------------------------------------------------------------------------------------------------- |
| Facebook | com.facebook.Facebook | 544.0.0 | IPA       | [Download](https://github.com/reversionet/Facebook-iOS-SSL-Pinning-Bypass/releases/download/v544/Facebook544.ipa) |
